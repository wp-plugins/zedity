...
>WP 3.9 COMPATIBILITY: due to the changes introduced by WordPress 3.9, Zedity versions prior to 3.1.2 are not fully compatible with WP 3.9. As minor compatibility issues might have to be fixed, please make sure to install the latest Zedity version available.
