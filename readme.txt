...
>WP 3.9 UPDATE: due to changes introduced by WordPress 3.9, Zedity version older than 3.1.1 are not compatible with WP 3.9. Please make sure to install the latest Zedity version.
