...
A revolutionary visual editor to create posts and pages easily and quickly, with unprecedented possibilities and absolutely no coding needed!
...
**Here is why Zedity quickly gained very high popularity in the WordPress community:**

* **Super Easy For Anyone**: simply stated, just forget about dealing with HTML, CSS and JavaScript coding. With Zedity you can create your content entirely visually, as naturally as if you're sketching on a piece of paper: Zedity will generate the code **automatically for you**, under the hood, totally hassle-free!
...
* **Saves you time and money**: what would take hours of coding, takes only minutes with Zedity! Furthermore, since you can do it without hiring developers, you will also save money!
  
* **24/7 Technical Support**: we love what we do and we're available to assist you. Even if you're not ready to upgrade to the Premium version, which, among the many other benefits, comes with high priority assistance, no worries: we offer technical assistance to free users as well! If you encounter a problem, all you have to do is to [submit a ticket](http://zedity.com/support) and we will get back to you. We also reply to the questions on the forums, with a lower priority though: so, if you happen to wait for a few hours, please refrain from thinking that we don't want to help and consider that we also happen to eat and sleep... :) Last but not least, constructive feedback is always welcome!
...
*   [Help, FAQ and Support](http://zedity.com/support): get technical assistance, ask for information or provide your feedback directly from your free Zedity account. 
...
**Do you like Zedity?**: please support the free version with a little donation. If not the right time to [donate](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=PRACALSXMQ5PY), we'd appreciate it much if you can take the time to [add your review](https://wordpress.org/support/view/plugin-reviews/zedity) Thanks!!!
...
A: Yes, here you can find useful information, videos and our [Tutorials](zedity.com/blog/tutorials).
