...
The best editor to create your content easily, quickly and with unprecedented possibilities! Zedity is already available in multiple languages.
...
Other languages are coming soon... Would you like to collaborate and **get rewarded** to [translate Zedity into your language](http://zedity.com/translate/)?
...
A: After installing and enabling the plugin, a new button ("Z") appears in the WordPress Visual Editor. Just click on the "Z" button to open Zedity, and you can start adding your content right away. Once you're done, save your content ("Content" -> "Save") to exit the Zedity Editor: your content is now ready to be either previewed or published. You can add Zedity content anywhere in your blog or site, as many times as you want.
