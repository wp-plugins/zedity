...
>All users should **update to the latest version 6** to take advantage of the brand new user interface, support for touchscreen devices and other [new features]( https://zedity.com/plugin/wpfeatures ). If you're still on versions 5.x, 4.x and other obsolete ones, we recommend you to update now, it's free!
