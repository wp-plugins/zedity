=== Zedity™ Creating Posts and Pages made Easy and Fun!===
Contributors: zuyoy
...
Zedity makes it incredibly easy, quick and fun for anyone to create professional and beautiful posts and pages. 100% visual, no coding required!
...
>**Major Free Upgrade!** With a brand new user interface, support for touchscreen devices and many [new features]( https://zedity.com/plugin/wpfeatures ), the Zedity 6 series is a major step forward for all users!
...
* **It unleashes the potential of your site**: unprecedented flexibility and possibilities to create any desired design. Let's consider the simplest example: how would you place some text on top of an image? Well, with the standard WordPress visual editor, that is just not possible. With Zedity, you can do that, and much more than that, in just few clicks!
...
* **We offer dedicated support**: we love what we do and we're available to assist you. If you encounter a problem, please [submit a ticket]( https://zedity.com/support ). We also reply to the questions on the forums, with a lower priority though: so, if you happen to wait for a few hours, please refrain from thinking that we don't want to help and consider that we also happen to eat and sleep... :) Last but not least, constructive feedback is always welcome!
