...
**100% WordPress Compatible**: Zedity works on any version of WordPress starting from 3.5 up to the latest ones. As a rule of thumb, please download the latest version (if you use outdated versions, WP 4.0+ requires at least Zedity 4.2.1, while WP 3.9+ requires at least Zedity 3.1.2).
